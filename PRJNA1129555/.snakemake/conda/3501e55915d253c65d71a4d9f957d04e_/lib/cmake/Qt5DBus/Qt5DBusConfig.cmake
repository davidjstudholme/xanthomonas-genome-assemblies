...
set(Qt5DBus_VERSION_STRING 5.15.15)
...
if (NOT TARGET Qt5::DBus)
    ...
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/qt/QtDBus/5.15.15"
        "${_qt5DBus_install_prefix}/include/qt/QtDBus/5.15.15/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.15 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.15.15" "" FALSE)
