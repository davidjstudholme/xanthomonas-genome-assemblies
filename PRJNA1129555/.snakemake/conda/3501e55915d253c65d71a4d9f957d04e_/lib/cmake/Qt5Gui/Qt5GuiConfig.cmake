...
set(Qt5Gui_VERSION_STRING 5.15.15)
...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/qt/QtGui/5.15.15"
        "${_qt5Gui_install_prefix}/include/qt/QtGui/5.15.15/QtGui"
    )
    ...
    foreach(_module_dep ${_Qt5Gui_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.15 ${_Qt5Gui_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 xkbcommon;xkbcommon-x11;xcb;drm_atomic;egl;eglfs;kms;eglfs_egldevice;xlib;xcb-xlib;evdev;freetype;system-freetype;fontconfig;gif;harfbuzz;ico;imageio-text-loading;jpeg;multiprocess;png;raster-64bit;system-harfbuzz;system-jpeg;system-png;system-xcb-xinput;tuiotouch;vkgen;vnc;xcb-glx-plugin;xcb-glx;xcb-sm)
    set_property(TARGET Qt5::Gui
    ...
    _populate_Gui_target_properties(RELEASE "libQt5Gui.so.5.15.15" "" FALSE)
